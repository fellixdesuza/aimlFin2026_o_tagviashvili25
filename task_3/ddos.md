...
- Link: [`o_tagviashvili25_61845_server.log`](o_tagviashvili25_61845_server.log)
...
def detect_attack_minutes(idx, y, pred_log, fit_mask):
    ...
    return z, intervals
```
Whole scrypt is in this file: `task_3/ddos_detect.py`
---
...
1. Put the log file in the same folder where is the scrypt:
